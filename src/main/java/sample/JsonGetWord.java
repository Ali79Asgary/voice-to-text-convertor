...
//کلاسی که آیدی یک سند را دریافت میکند و فایل pdf مربوط به آن سند را برای ما برمیگرداند.
public class JsonGetWord extends Task {

    int responseCode = 0;
    int documentID = 0;
    Label lblVoiceToText;

    public JsonGetWord(int documentID) {
    ...
    protected Object call() throws Exception {
        try {
            ...
            Request request = new Request.Builder()
                    .url("http://deepmine.ir:8890/api/document2docx/")
                    .method("GET", null)
